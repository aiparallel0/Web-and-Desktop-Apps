...
try:
    ...
    from shared.circular_exchange.cefr import (
        CEFRefactoringEngine, SuggestionType, ImpactLevel, EffortLevel
    )
    from shared.circular_exchange.feedback_loop import FeedbackLoop
    from shared.circular_exchange.intelligent_analyzer import IntelligentAnalyzer
    from shared.circular_exchange.autonomous_refactor import (
        AutonomousRefactor, RefactorResult, RiskLevel
    )
    CEF_AVAILABLE = True
